...
:::tip
你也可以使用你喜欢的编辑器（例如 VSCode）来编辑文件。Yuan 将检测文件变更并自动重新加载代理。
:::

## Hello World 时间！

现在，让我们在编辑器中编写代码。以下代码是代理的基本框架。
...
1. 我们使用 `useParamString` 从代理配置表单中获取参数。
