...
let perpMetaCache: { expires_at: number; map: Map<string, { assetId: number; szDecimals: number }> } | undefined;
let spotMetaCache: { expires_at: number; map: Map<string, { assetId: number; szDecimals: number }> } | undefined;
