import { makeSpotPosition, type IPosition, type IActionHandlerOfGetAccountInfo } from '@yuants/data-account';
 ...
 * 获取理财账户信息
 */
export const getEarningAccountInfo: IActionHandlerOfGetAccountInfo<ICredential> = async (
  credential,
  account_id,
) => {
